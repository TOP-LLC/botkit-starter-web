...
module.exports = function (controller) {
  ...
  controller.studio.validate('challenge_metric_start', 'string_question_1', (convo, next) => {
  ...
  controller.studio.validate('challenge_metric_start', 'image_question_1', (convo, next) => {
    const value = convo.extractResponse('image_question_1');

    // test or validate value somehow
    // can call convo.gotoThread() to change direction of conversation

    console.log('VALIDATE: challenge_metric_start VARIABLE: image_question_1');
  ...
  controller.studio.validate('challenge_metric_start', 'challenge_accept', (convo, next) => {
    ...
    console.log('VALIDATE: challenge_metric_start VARIABLE: challenge_accept');
  ...
  controller.studio.validate('challenge_metric_start', 'question_1', (convo, next) => {
    const value = convo.extractResponse('question_1');

    // test or validate value somehow
    // can call convo.gotoThread() to change direction of conversation

    console.log('VALIDATE: challenge_metric_start VARIABLE: question_1');
  ...
  controller.studio.validate('challenge_metric_start', 'question_2', (convo, next) => {
    const value = convo.extractResponse('question_2');

    // test or validate value somehow
    // can call convo.gotoThread() to change direction of conversation

    console.log('VALIDATE: challenge_metric_start VARIABLE: question_2');
  ...
  controller.studio.validate('challenge_metric_start', 'question_3', (convo, next) => {
    const value = convo.extractResponse('question_3');

    // test or validate value somehow
    // can call convo.gotoThread() to change direction of conversation

    console.log('VALIDATE: challenge_metric_start VARIABLE: question_3');
  ...
  controller.studio.beforeThread('challenge_metric_start', 'default', (convo, next) => {
    // / do something fun and useful
    // convo.setVar('name','value');

    console.log('In the script *challenge_metric_start*, about to start the thread *default*');
  ...
  controller.studio.beforeThread(
    'challenge_metric_start',
    'all_challenges_completed',
    (convo, next) => {
      // / do something fun and useful
      // convo.setVar('name','value');

      console.log('In the script *challenge_metric_start*, about to start the thread *all_challenges_completed*');
  ...
  controller.studio.beforeThread('challenge_metric_start', 'changed_mind', (convo, next) => {
    // / do something fun and useful
    // convo.setVar('name','value');

    console.log('In the script *challenge_metric_start*, about to start the thread *changed_mind*');
  ...
  controller.studio.beforeThread(
    ...
    (convo, next) => {
      ...
      console.log('In the script *challenge_metric_start*, about to start the thread *image_challenge_type*');
  ...
  controller.studio.beforeThread(
    ...
    (convo, next) => {
      ...
      console.log('In the script *challenge_metric_start*, about to start the thread *image_challenge_not_matched*');
  ...
  controller.studio.beforeThread(
    ...
    (convo, next) => {
      ...
      console.log('In the script *challenge_metric_start*, about to start the thread *string_challenge_type*');
  ...
  controller.studio.beforeThread(
    ...
    (convo, next) => {
      ...
      console.log('In the script *challenge_metric_start*, about to start the thread *string_challenge_not_matched*');
  ...
  controller.studio.beforeThread('challenge_metric_start', 'challenge_submitted', (convo, next) => {
    // / do something fun and useful
    // convo.setVar('name','value');

    console.log('In the script *challenge_metric_start*, about to start the thread *challenge_submitted*');
  ...
  controller.studio.after('challenge_metric_start', (convo, next) => {
    console.log('AFTER: challenge_metric_start');
